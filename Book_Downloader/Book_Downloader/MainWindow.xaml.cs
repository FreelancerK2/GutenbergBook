...
namespace Book_Downloader
{
    public partial class MainWindow : Window
    {
        ...
        private async void DownloadButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("No book URL found!", "Error", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }

            try
            {
                string bookUrl = TextUrl.Text;
                string fileName = SelectedBookTitle.Text + ".pdf"; // Assuming a PDF file
                ...
                MessageBox.Show($"Download Complete! File saved at: {savePath}", "Success", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (HttpRequestException ex)
            {
                MessageBox.Show($"Network error: {ex.Message}", "Download Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            catch (UnauthorizedAccessException)
            {
                MessageBox.Show("You don't have permission to save the file in this location.", "Permission Denied", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
            catch (IOException ex)
            {
                MessageBox.Show($"File error: {ex.Message}", "File Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            catch (Exception ex)
            {
